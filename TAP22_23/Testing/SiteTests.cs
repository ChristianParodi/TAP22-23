...
namespace TAP22_23.AuctionSite.Testing {
    public class SiteTests : AuctionSiteTests {
        ...
        /// <summary>
        ///     Verify that the username respects DomainConstraints.MinUserName and DomainConstraints.MaxUserName
        /// </summary>
        [Test]
        [TestCase("yu")]
        [TestCase("asdfffffdfafafsdfasfhihjsdbfjasbfiabfdksbfaksbfklbdfklfbdbafkhsdbfhabdbfjk")]
        public void Login_InvalidUsernameLength(string username) {
            Assert.That(() => Site.Login(username, "pluto"), Throws.TypeOf<AuctionSiteArgumentException>());
        }
    }
}